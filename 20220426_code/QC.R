...
for(subrow in 1:nrows){
    ...
    ggsave(paste("step2/image/step2_",sam_name,"_filter_Count_MT_VlnPlot.pdf",sep=""),width=8,height=6,dpi=600)
    ggsave(paste("step2/image/step2_",sam_name,"_filter_Count_MT_VlnPlot.png",sep=""),width=8,height=6,dpi=600)
    ...
    plot1 + plot2
    ggsave(paste("step2/image/step2_",sam_name,"_filter_Count_MT_Scatter.pdf",sep=""),width=8,height=6,dpi=600)
    ggsave(paste("step2/image/step2_",sam_name,"_filter_Count_MT_Scatter.png",sep=""),width=8,height=6,dpi=600)
    ...
    saveRDS(seuobj, file = paste("step2/step2_",sam_name,"_filter.Rds",sep=""))
}

colnames(cell_stat)<-c("sample","clean_cell")
cell_stat$clean_cell<-as.numeric(cell_stat$clean_cell)
write.table(cell_stat,"step2/step2_samples_clean_cell_num.csv",sep=",",quote=FALSE,col.names=TRUE,row.names=FALSE)
