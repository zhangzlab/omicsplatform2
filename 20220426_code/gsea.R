...
for(num in 1:nrows){
	...
	for(order in 1:num_gsea){
		 ...
		 preout<-paste("step8/image/step8_",case_name,"-vs-",ctl_name,"_",opt$db,"_",gsea_title,sep="")
	...
	out_file<-paste("step8/step8_",case_name,"-vs-",ctl_name,"_",opt$db,"_gsea.csv",sep="")
