...
for(subrow in 1:nrows){
    ...
    ggsave(paste("step1/image/step1_",sam_name,"_raw_Count_MT_VlnPlot.pdf",sep=""),width=8,height=6,dpi=600)
    ggsave(paste("step1/image/step1_",sam_name,"_raw_Count_MT_VlnPlot.png",sep=""),width=8,height=6,dpi=600)
    ...
    plot1 + plot2
    ggsave(paste("step1/image/step1_",sam_name,"_raw_Count_MT_Scatter.pdf",sep=""),width=8,height=6,dpi=600)
    ggsave(paste("step1/image/step1_",sam_name,"_raw_Count_MT_Scatter.png",sep=""),width=8,height=6,dpi=600)
    ...
    saveRDS(seuobj,paste("step1/step1_",sam_name,"_raw.Rds",sep=""))
    
}
colnames(cell_stat)<-c("sample","raw_cell")
write.table(cell_stat,paste("step1/step1_samples_raw_cell_num.csv",sep=""),sep=",",row.names=FALSE,quote=FALSE)
