...
for(num in 1:ngenes)
	...
	ggsave(paste("step4/image/step4_",gene_name,"_exp_features.pdf",sep=""),width=8,height=6)
	ggsave(paste("step4/image/step4_",gene_name,"_exp_features.png",sep=""),width=8,height=6)

	VlnPlot(data, features =genes[num,1],group.by='celltype')
	ggsave(paste("step4/image/step4_",gene_name,"_exp_vlnplot.pdf",sep=""),width=nwidths,height=5)
	ggsave(paste("step4/image/step4_",gene_name,"_exp_vlnplot.png",sep=""),width=nwidths,height=5)
},silent=TRUE)
...
ggsave("step4/image/step4_all_genes_exp_point_features.pdf",width=nwidths,height=nheights)
ggsave("step4/image/step4_all_genes_exp_point_features.png",width=nwidths,height=nheights)
