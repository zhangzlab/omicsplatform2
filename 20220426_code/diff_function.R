...
write.table(as.data.frame(ALL@result), file="step7/step7_all_GO.csv",quote=FALSE,sep=",",col.names=TRUE,row.names=FALSE)
...
ggsave("step7/image/step7_CC_function.pdf",width=15,height=height_cc,useDingbats=FALSE)
ggsave("step7/image/step7_CC_function.png",width=15,height=height_cc)
...
p <- p + scale_y_continuous(limits =c(0,maxvalue+1),breaks=seq(0,maxvalue+1,2),labels=seq(0,maxvalue+1,2))
p <- p + guides(fill=FALSE)
ggsave("step7/image/step7_BP_function.pdf",width=15,height=height_bp,useDingbats=FALSE)
ggsave("step7/image/step7_BP_function.png",width=15,height=height_bp)
...
p <- p + scale_y_continuous(limits =c(0,maxvalue+1),breaks=seq(0,maxvalue+1,2),labels=seq(0,maxvalue+1,2))
p <- p + guides(fill=FALSE)
ggsave("step7/image/step7_MF_function.pdf",width=15,height=height_mf,useDingbats=FALSE)
ggsave("step7/image/step7_MF_function.png",width=15,height=height_mf)

write.table(as.data.frame(CC_simp@result),file="step7/step7_CC_GO_simp.csv",quote=FALSE,sep=",",col.names=TRUE,row.names=FALSE)
write.table(as.data.frame(BP_simp@result),file="step7/step7_BP_GO_simp.csv",quote=FALSE,sep=",",col.names=TRUE,row.names=FALSE)
write.table(as.data.frame(MF_simp@result),file="step7/step7_MF_GO_simp.csv",quote=FALSE,sep=",",col.names=TRUE,row.names=FALSE)
...
p <- p + scale_y_continuous(limits =c(0,maxvalue+1),breaks=seq(0,maxvalue+1,2),labels=seq(0,maxvalue+1,2))
p <- p + guides(fill=FALSE)
ggsave("step7/image/step7_kegg_function.pdf",width=15,height=height_kegg,useDingbats=FALSE)
ggsave("step7/image/step7_kegg_function.png",width=15,height=height_kegg)

write.table(as.data.frame(keggs@result), file="step7/step7_KEGG.csv",quote=FALSE,sep=",",col.names=TRUE,row.names=FALSE)
